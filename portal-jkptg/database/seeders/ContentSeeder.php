...
class ContentSeeder extends Seeder
{
    ...
    private function seedCawangan(): void
    {
        $cawangan = [
            ...
            ['cawangan-perak', 'Cawangan Perak', 'Perak Branch', 'Perak',
                ['ms' => 'Bangunan Persekutuan, Jalan Tun Abdul Razak, 30100 Ipoh', 'en' => 'Federal Building, Jalan Tun Abdul Razak, 30100 Ipoh'],
                '05-241 7000', null, 'perak@jkptg.gov.my', 4.5975, 101.0901, false],
            ['cawangan-kedah', 'Cawangan Kedah', 'Kedah Branch', 'Kedah',
                ['ms' => 'Aras 5, Wisma Persekutuan, 05000 Alor Setar', 'en' => 'Level 5, Wisma Persekutuan, 05000 Alor Setar'],
                '04-733 6000', null, 'kedah@jkptg.gov.my', 6.1184, 100.3686, false],
            ['cawangan-perlis', 'Cawangan Perlis', 'Perlis Branch', 'Perlis',
                ['ms' => 'Bangunan Persekutuan, 01000 Kangar', 'en' => 'Federal Building, 01000 Kangar'],
                '04-976 1000', null, 'perlis@jkptg.gov.my', 6.4413, 100.1986, false],
            ['cawangan-kelantan', 'Cawangan Kelantan', 'Kelantan Branch', 'Kelantan',
                ['ms' => 'Wisma Persekutuan, Jalan Bayam, 15200 Kota Bharu', 'en' => 'Wisma Persekutuan, Jalan Bayam, 15200 Kota Bharu'],
                '09-748 4000', null, 'kelantan@jkptg.gov.my', 6.1248, 102.2477, false],
            ['cawangan-terengganu', 'Cawangan Terengganu', 'Terengganu Branch', 'Terengganu',
                ['ms' => 'Wisma Persekutuan, 20200 Kuala Terengganu', 'en' => 'Wisma Persekutuan, 20200 Kuala Terengganu'],
                '09-622 1000', null, 'terengganu@jkptg.gov.my', 5.3286, 103.1411, false],
            ['cawangan-pahang', 'Cawangan Pahang', 'Pahang Branch', 'Pahang',
                ['ms' => 'Bangunan Persekutuan, 25000 Kuantan', 'en' => 'Federal Building, 25000 Kuantan'],
                '09-573 5000', null, 'pahang@jkptg.gov.my', 3.8077, 103.3260, false],
            ['cawangan-negeri-sembilan', 'Cawangan Negeri Sembilan', 'Negeri Sembilan Branch', 'Negeri Sembilan',
                ['ms' => 'Wisma Persekutuan, 70000 Seremban', 'en' => 'Wisma Persekutuan, 70000 Seremban'],
                '06-762 8000', null, 'nsembilan@jkptg.gov.my', 2.7297, 101.9381, false],
            ['cawangan-melaka', 'Cawangan Melaka', 'Melaka Branch', 'Melaka',
                ['ms' => 'Bangunan Persekutuan, 75000 Bandar Hilir', 'en' => 'Federal Building, 75000 Bandar Hilir'],
                '06-282 1000', null, 'melaka@jkptg.gov.my', 2.1896, 102.2501, false],
            ['cawangan-sabah', 'Cawangan Sabah', 'Sabah Branch', 'Sabah',
                ['ms' => 'Bangunan Persekutuan, 88000 Kota Kinabalu', 'en' => 'Federal Building, 88000 Kota Kinabalu'],
                '088-251 800', null, 'sabah@jkptg.gov.my', 5.9788, 116.0753, false],
            ['cawangan-sarawak', 'Cawangan Sarawak', 'Sarawak Branch', 'Sarawak',
                ['ms' => 'Bangunan Persekutuan, 93000 Kuching', 'en' => 'Federal Building, 93000 Kuching'],
                '082-243 000', null, 'sarawak@jkptg.gov.my', 1.5535, 110.3593, false],
            ['cawangan-wp-labuan', 'Cawangan WP Labuan', 'WP Labuan Branch', 'WP Labuan',
                ['ms' => 'Aras 3, Bangunan Ujana Kewangan, 87000 Labuan', 'en' => 'Level 3, Ujana Kewangan Building, 87000 Labuan'],
                '087-414 000', null, 'labuan@jkptg.gov.my', 5.2783, 115.2475, false],
            ['cawangan-wp-kuala-lumpur', 'Cawangan WP Kuala Lumpur', 'WP Kuala Lumpur Branch', 'WP Kuala Lumpur',
                ['ms' => 'Bangunan Sulaiman, Jalan Sultan Hishamuddin, 50000 Kuala Lumpur', 'en' => 'Sulaiman Building, Jalan Sultan Hishamuddin, 50000 Kuala Lumpur'],
                '03-2693 0000', null, 'wpkl@jkptg.gov.my', 3.1390, 101.6869, false],
        ];
