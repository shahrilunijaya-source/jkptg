...
@section('content')
<x-statement-band :label="__('messages.utility.hubungi')" :title="__('messages.hubungi.branches')" :subtitle="trans_choice('messages.hubungi.branch_count', $branches->count(), ['count' => $branches->count()])" />
