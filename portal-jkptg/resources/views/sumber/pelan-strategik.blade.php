...
<section class="bg-gradient-to-br from-primary to-primary-mute text-white py-12">
    <div class="container-page">
        <div class="flex items-center gap-2 text-jata-yellow text-sm uppercase tracking-wider mb-2">
            ...
            <span>{{ __('messages.sumber.pelan_strategik') }}</span>
        </div>
        <h1 class="font-display text-3xl md:text-5xl font-bold mb-3">{{ __('messages.sumber.pelan_strategik') }}</h1>
        <p class="text-white/85 max-w-2xl">{{ __('messages.sumber.pelan_desc') }}</p>
    </div>
</section>
