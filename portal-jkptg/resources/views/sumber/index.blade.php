...
<section class="py-12">
    <div class="container-page">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach([
                ['icon' => 'photo', 'label' => __('messages.sumber.galeri'), 'desc' => __('messages.sumber.galeri_desc')],
                ['icon' => 'chart-bar', 'label' => __('messages.sumber.data_terbuka'), 'desc' => __('messages.sumber.data_desc')],
                ['icon' => 'presentation-chart-line', 'label' => __('messages.sumber.pelan_strategik'), 'desc' => __('messages.sumber.pelan_desc')],
                ['icon' => 'book-open', 'label' => __('messages.sumber.penerbitan'), 'desc' => __('messages.sumber.penerbitan_desc')],
                ['icon' => 'sparkles', 'label' => __('messages.sumber.infografik'), 'desc' => __('messages.sumber.infografik_desc')],
                ['icon' => 'archive-box', 'label' => __('messages.sumber.arkib'), 'desc' => __('messages.sumber.arkib_desc')],
            ] as $item)
